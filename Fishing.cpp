...
// класс который открывает файлы, +
// класс кот имеет тот класс будет чиать из файла строчку за строчкой (построчное чтение) +
// класс обработка лайнов (название строк) 
// класс который скрещен со всеми предыдущими
